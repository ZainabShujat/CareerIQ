...
export default function Engineering() {
  ...
  useEffect(() => {
    ...
    fetch("/api/careers")
      ...
      .catch(() => {
        // fallback to local file if you have it during dev
        try {
  ...
  return (
    <div className="ciq-container" style={{ paddingTop: 48 }}>
      ...
      <div className="muted" style={{ marginBottom: 16 }}>Design, build and maintain physical & software systems.</div>

      {careers.length === 0 ? (
        <div className="muted">No engineering careers found yet.</div>
      ) : (
        <div className="cards">
